package com.zensar.olx.masterdata.rest;
...
import com.zensar.olx.masterdata.service.CategoryService;
...
public class CategoryController {
	...
	public Category getcCategory(@PathVariable(name = "id") int id) {
